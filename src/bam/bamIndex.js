...
const BinaryParser = require("../util/binary")
...
class BamIndex {
    ...
    constructor(arrayBuffer, bgZipped) {
        ...
        if (magic === BAI_MAGIC || magic === TABIX_MAGIC) {
            ...
            throw new Error(this.indexFile + " is not a " + (bgZipped ? "tabix" : "bai") + " file");
        }
        this.init(indices, blockMin, blockMax, sequenceIndexMap, bgZipped)
    }

    init(indices, blockMin, blockMax, sequenceIndexMap, tabix) {
